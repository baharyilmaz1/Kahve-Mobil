...
private Toolbar toolbar;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_kahve) {
            fragment= new kahveFragment();

        } else if (id == R.id.nav_kahvemakinesi) {
            fragment= new kahvemakinesiFragment();

        } else if (id == R.id.nav_matara) {
            fragment=new mataraFragment();

        } else if (id == R.id.nav_mug) {
            fragment=new mugFragment();
